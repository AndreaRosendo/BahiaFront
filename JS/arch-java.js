function BotonDark() {
  ...
  const nuevaImagenURL = "url(../Imagenes/Mapamundi-negro.png)";
  document.body.style.backgroundImage = nuevaImagenURL;
...
function BotonWhite() {
  ...
  const nuevaImagenURL = "url(../Imagenes/Mapamundi-blanco.png)";
  document.body.style.backgroundImage = nuevaImagenURL;
